<html>
    ...
    <form action="products.php" method="POST" onsubmit="return validation(this)">
        <table>
            <tr><td><label for="pname">Product name:</label></td><td><input type="text" name="pname"/></td></tr>
            <tr><td><label for="price:">Price:</label></td><td><input type="text" name="price"/></td></tr>
